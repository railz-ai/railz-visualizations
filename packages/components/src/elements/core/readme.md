...
| `filter`        | --        | Filter information to query the backend APIs                | `RVFilterAccountingMethod \| RVFilterBalanceSheet \| RVFilterBankAccount \| RVFilterBills \| RVFilterCashflowStatements \| RVFilterCreditScore \| RVFilterDate \| RVFilterExpenses \| RVFilterFinancialRatio \| RVFilterIncomeStatements \| RVFilterInvoices \| RVFilterRevenue` | `undefined` |
