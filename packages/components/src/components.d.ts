...
import { RVConfiguration, RVFilterAllReportTypes, RVFilterBankAccount, RVFilterFinancialRatio, RVFilterGauge, RVFilterPie, RVFilterStatements, RVFilterTransactions, RVGaugeChartSummary, RVOptions, RVOptionsBarStyle, RVPeriodData, RVReportTypes, RVSelectStyle, RVTooltipStyle } from "./types";
...
declare global {
    ...
    interface HTMLRailzGaugeChartComponentElement extends Components.RailzGaugeChartComponent, HTMLStencilElement {
    }
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            ...
            "railz-gauge-chart-component": LocalJSX.RailzGaugeChartComponent & JSXBase.HTMLAttributes<HTMLRailzGaugeChartComponentElement>;
