...
export interface RVBaseFilterConnectionDateFrequency
  extends RVBaseFilterConnectionDate {
  reportFrequency: RVReportFrequency;
}

export interface RVBaseFilterBusinessDateFrequency
  extends RVBaseFilterBusinessDate {
  reportFrequency: RVReportFrequency;
}
...
export interface RVBaseFilterBusinessDateFrequencyType
  extends RVBaseFilterBusinessDateFrequency {
  reportType: RVFrequencyTypes;
}

export interface RVBaseFilterConnectionDateType
  extends RVBaseFilterBusinessDate {
  reportType: RVNoFrequencyTypes;
}

export interface RVBaseFilterBusinessDateType
  extends RVBaseFilterConnectionDate {
  reportType: RVNoFrequencyTypes;
}

export type RVBaseFilter = RVBaseFilterBusiness | RVBaseFilterConnection;
export type RVBaseFilterDate =
  | RVBaseFilterConnectionDate
  | RVBaseFilterBusinessDate;
export type RVBaseFilterDateFrequency =
  | RVBaseFilterConnectionDateFrequency
  | RVBaseFilterBusinessDateFrequency;
export type RVBaseAllFilter =
  | RVBaseFilter
  | RVBaseFilterDate
  | RVBaseFilterDateFrequency;
export type RVFilterFrequency =
  | RVBaseFilterConnectionDateFrequencyType
  | RVBaseFilterBusinessDateFrequencyType;
export type RVFilterDate =
  | RVBaseFilterConnectionDateType
  | RVBaseFilterBusinessDateType;
export type RVFilterType =
  | RVBaseFilterConnectionType
  | RVBaseFilterBusinessType;
