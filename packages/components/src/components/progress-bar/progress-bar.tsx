      ...
      <div class="railz-progress-bar-div">
        <p class="railz-progress-bar-total-unpaid">
          ...
          {this.reportType === "invoices"
            ...
            : Translations.BILLS}{" "}
          <span class="railz-progress-bar-total-unpaid-value">
        ...
        <div class="railz-progress-bar-values">
          <div class="railz-progress-bar-values-div">
            <div>
              ...
              <p class="railz-progress-bar-value">
                ${formatNumber(this.paidAmount)}
              </p>
            </div>
            <div>
              <p class="railz-progress-bar-label railz-progress-bar-overdue">
                {Translations.OVERDUE}
              </p>
              <p class="railz-progress-bar-value railz-progress-bar-overdue">
