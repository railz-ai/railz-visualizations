...
| `filter` _(required)_        | --        | Filter information to query the backend APIs                | `RVBaseFilterBusinessDateFrequencyType & { reconstruct: boolean; } \| RVBaseFilterConnectionDateFrequencyType & { reconstruct: boolean; }` | `undefined` |
