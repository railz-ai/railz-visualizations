...
>('railz-bank-accounts');
export const RailzBankReconciliation = /*@__PURE__*/ createReactComponent<
...
export const RailzVisualizations = /*@__PURE__*/ createReactComponent<
  JSX.RailzVisualizations,
  HTMLRailzVisualizationsElement
