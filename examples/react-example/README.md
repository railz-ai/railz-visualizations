...
It demonstrates how to setup visualizations with React via the `@railzai/railz-visualizations-react` package
...
<p align="center"><i>Visualizations SDK React Usage Example.</i></p>
