...
export default function Form({setFilter, setAuthentication, setError, options, setOptions}: FormProps) {
    ...
    return (
        <>
            ...
            {options && <div className="mt-4 sm:mt-4">
                <OptionsForm options={options} setOptions={setOptions}/>
            </div>}
            <div className="mt-4 sm:mt-4">
                <FilterForm setFilter={setFilter} setAuthentication={setAuthentication} setError={setError}/>
            </div>
        </>
    )
}
