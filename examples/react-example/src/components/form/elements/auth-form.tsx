...
export default function AuthForm({ setAuthentication, setError}: FormProps) {
    const [formAuth, setFormAuth] = useState<AuthenticationParameters>({authUrl: ''});
    ...
    return (
        <div className="flex flex-col">
            <div className="text-left">
                ...
                <p className="mt-1 text-sm text-gray-600">Include your Authentication server URL here, see our quickstart example <a href="https://github.com/railz-ai/railz-visualizations/tree/master/examples/nodejs" target="_blank" className="underline" rel="noopener noreferrer">here</a>.</p>
