        ...
        <div className="flex flex-col">
            <div className="md:col-span-1">
                <div className="text-left">
                    ...
                    <p className="mt-1 text-sm text-gray-600">Optional parameters for the SDK, they cannot be dynamically changed and should be set before clicking on the filter submit button. They are for customization of content and styles</p>
                </div>
            </div>
            <div className="mt-2 md:mt-2 md:col-span-2 text-left">
                { setOptions && <ReactJson src={formOptions} onEdit={submitOptions} onAdd={submitOptions} collapsed={true}/>}
            </div>
        </div>
    )
}
