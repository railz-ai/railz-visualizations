...
import {
    ...
    RVBankingProviders,
    RVReportFrequency, RVReportTypes,
    RVSandboxProviders
                        ...
                        <div className="grid grid-cols-6 gap-6 items-end">
                            <div className="col-span-6 lg:col-span-6">
                                <label htmlFor="business-name"
                                       className="block text-sm font-medium text-gray-700">Business Name</label>
                            ...
                            <div className="col-span-6 lg:col-span-3">
                                <label htmlFor="service-name"
                                       className="block text-sm font-medium text-gray-700">Service Name</label>
                            ...
                            <div className="col-span-6 lg:col-span-3">
                                <label htmlFor="business-name"
                                       className="block text-sm font-medium text-gray-700">Connection Id</label>
                                <input type="text" name="connectionId" id="connection-id"
                                       onChange={handleFilterChange}
                            ...
                            <div className="col-span-6 lg:col-span-3">
                                <label htmlFor="report-type"
                                       className="block text-sm font-medium text-gray-700">Report Type</label>
                            ...
                            <div className="col-span-6 lg:col-span-3">
                                <label htmlFor="start-date" className="block text-sm font-medium text-gray-700">Start
                                    Date</label>
                            ...
                            <div className="col-span-6 lg:col-span-3">
                                <label htmlFor="end-date" className="block text-sm font-medium text-gray-700">End
                                    Date</label>
                            ...
                            <div className="col-span-6 lg:col-span-3">
                                <label htmlFor="report-frequency"
                                       className="block text-sm font-medium text-gray-700">Report
                                    Frequency</label>
                                <select id="report-frequency" name="reportFrequency"
                                        onChange={handleFilterChange}
