        ...
        <div className="text-left">
            ...
            <div className="grid grid-cols-2 gap-4 mx-auto mt-6">
                ...
                <div className="col-span-1 flex flex-col">
                    ...
                    <div className="shadow p-4 mt-2 flex items-center h-full">
                        <RailzProgressBar reportType={RVReportTypes.INVOICES} unpaidAmount={15000} paidAmount={0}
                                          overdueAmount={2000}/>
                    </div>
                </div>
                <div className="col-span-1 flex flex-col">
                    ...
                    <div className="shadow p-4 mt-2 flex items-center h-full">
                        <RailzProgressBar reportType={RVReportTypes.BILLS} unpaidAmount={13000} paidAmount={0} overdueAmount={5000} options={{
                            barStyle: {
                                background: "#a6d2ac"
                            }
                        }}/>
                ...
                <div className="col-span-1 flex flex-col">
                    ...
                    <div className="shadow p-4 mt-2 flex items-center h-full">
                        <RailzProgressBar reportType={RVReportTypes.INVOICES} unpaidAmount={12000} paidAmount={15000}
                                          overdueAmount={2000}/>
                    </div>
                </div>
                <div className="col-span-1 flex flex-col">
                    ...
                    <div className="shadow p-4 mt-2 flex items-center h-full">
                        <RailzProgressBar reportType={RVReportTypes.BILLS} unpaidAmount={0} paidAmount={15000} overdueAmount={0}
                                          options={{
                                              progressStyle: {
                                                  background: "#2e6521"
                                              },
